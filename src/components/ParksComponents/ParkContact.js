...
function ParkContact() {
  ...
  const formattedNumber = !phoneNumber.includes("-") ? `${phoneNumber.slice(0,3)}-${phoneNumber.slice(3,6)}-${phoneNumber.slice(6)}` : phoneNumber
      ...
      <Container>
          <TextContainer>
              ...
              <List>
                ...
                <ListItem>Phone : {formattedNumber}</ListItem>
